...
# 104 "src/record.c"
  ...
  unsigned data_line_size = (((sizeof(Levels))) + 30)*5 + strlen(output_get_audio_filepath());
  ...
  memory_needed = memory_needed * (100 + 0) / 100;
