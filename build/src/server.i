...
# 27 "/usr/include/x86_64-linux-gnu/bits/pthreadtypes.h" 3 4
...
# 39 "/usr/include/x86_64-linux-gnu/sys/un.h" 2 3 4
...
# 46 "src/server.c" 3 4
         stderr
# 46 "src/server.c"
               , "Error in \"socket(AF_UNIX, SOCK_DGRAM, 0)\"");
  exit(
# 47 "src/server.c" 3 4
      1
# 47 "src/server.c"
...
# 51 "src/server.c" 3 4
                       stderr
# 51 "src/server.c"
                             , "Error in \"fcntl(sockfd, F_GETFL, 0)\"");
                exit(
# 52 "src/server.c" 3 4
                    1
# 52 "src/server.c"
...
# 56 "src/server.c" 3 4
                       stderr
# 56 "src/server.c"
                             , "Error in \"fcntl(sockfd, F_SETFL, 0)\"");
                exit(
# 57 "src/server.c" 3 4
                    1
# 57 "src/server.c"
...
# 67 "src/server.c"
 ...
 result = listen(sockfd, (sizeof (sockcli_table) / sizeof (sockcli_table)[0]));
 if (result < 0) {
  fprintf(
# 72 "src/server.c" 3 4
         stderr
# 72 "src/server.c"
               , "Error in \"listen(sockfd, 0)\"");
  exit(
# 73 "src/server.c" 3 4
      1
# 73 "src/server.c"
  ...
  struct timespec time_point;
                timespec_get(&time_point, 
# 80 "src/server.c" 3 4
                                         1
# 80 "src/server.c"
                                                 );
                timespec_add_mili(&time_point, 100);
                ...
                if (result == thrd_success) {
                        ...
                        && sockcli_table_current < (sizeof (sockcli_table) / sizeof (sockcli_table)[0])) {
                        int sockclifd = accept(sockfd, 
# 101 "src/server.c" 3 4
                                                      ((void *)0)
# 101 "src/server.c"
                                                          , 0);
                        if (sockclifd < 0) {
                                if (
# 103 "src/server.c" 3 4
                                   (*__errno_location ()) 
# 103 "src/server.c"
                                         != 
# 103 "src/server.c" 3 4
...
# 103 "src/server.c"
                                        ...
                                        fprintf(
# 104 "src/server.c" 3 4
                                               stderr
# 104 "src/server.c"
                                                     , "Error in \"accept(sockfd, NULL, 0)\"");
                                        exit(
# 105 "src/server.c" 3 4
                                            1
# 105 "src/server.c"
                                                        );
                                }
                                ...
                                int flags = fcntl(sockclifd, 
# 109 "src/server.c" 3 4
                                                            3
# 109 "src/server.c"
                                                                   , 0);
                                if (flags < 0) {
                                        fprintf(
# 111 "src/server.c" 3 4
                                               stderr
# 111 "src/server.c"
                                                     , "Error in \"fcntl(sockfd, F_GETFL, 0)\"");
                                        exit(
# 112 "src/server.c" 3 4
                                            1
# 112 "src/server.c"
                                                        );
                                }
                                int result = fcntl(sockclifd, 
# 114 "src/server.c" 3 4
                                                             4
# 114 "src/server.c"
                                                                    , flags | 
# 114 "src/server.c" 3 4
...
# 114 "src/server.c"
                                ...
                                if (result < 0) {
                                        fprintf(
# 116 "src/server.c" 3 4
                                               stderr
# 116 "src/server.c"
                                                     , "Error in \"fcntl(sockfd, F_SETFL, 0)\"");
                                        exit(
# 117 "src/server.c" 3 4
                                            1
# 117 "src/server.c"
                                                        );
                                }
...
void server_init() {
        ...
        if (thrd_success != thrd_create(&server_thread, server_thread_func, 
# 130 "src/server.c" 3 4
                                                                           ((void *)0)
# 130 "src/server.c"
                                                                               )) {
                fprintf(
# 131 "src/server.c" 3 4
                       stderr
# 131 "src/server.c"
                             , "Error in \"thrd_create(&thread_server, server_thread_func, NULL)\"");
                exit(
# 132 "src/server.c" 3 4
                    1
# 132 "src/server.c"
                                );
        }
