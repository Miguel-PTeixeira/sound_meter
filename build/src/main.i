...
# 103 "src/main.c"
 ...
 int error_in_options = 
# 108 "src/main.c" 3 4
                       0
# 108 "src/main.c"
                            ;

 char *option_device_filename = 
# 110 "src/main.c" 3 4
                               ((void *)0)
# 110 "src/main.c"
                                   ;
 char *option_input_filename = 
# 111 "src/main.c" 3 4
                              ((void *)0)
# 111 "src/main.c"
                                  ;
 char *option_output_filename = 
# 112 "src/main.c" 3 4
                               ((void *)0)
# 112 "src/main.c"
                                   ;
 char *option_data_output_format = 
# 113 "src/main.c" 3 4
                                  ((void *)0)
# 113 "src/main.c"
                                      ;
 char *option_sample_rate = 
# 114 "src/main.c" 3 4
                           ((void *)0)
# 114 "src/main.c"
                               ;
 char *option_channels = 
# 115 "src/main.c" 3 4
                        ((void *)0)
# 115 "src/main.c"
                            ;
 char *option_identification = 
# 116 "src/main.c" 3 4
                              ((void *)0)
# 116 "src/main.c"
                                  ;
 char *option_calibration_time = 
# 117 "src/main.c" 3 4
                                ((void *)0)
# 117 "src/main.c"
                                    ;
 char *option_config_filename = 
# 118 "src/main.c" 3 4
                               ((void *)0)
# 118 "src/main.c"
                                   ;
 char *option_block_size = 
# 119 "src/main.c" 3 4
                          ((void *)0)
# 119 "src/main.c"
                              ;
...
# 122 "src/main.c"
 ...
 while ((option_char = getopt_long(argc, argv, ":hvd:i:o:f:r:a:n:t:c:g:b:",
  ...
  case 'r':
   ...
   do { if (!(strcmp(option_block_size,"44100") == 0 || strcmp(option_block_size,"48000") == 0)) { fprintf(
# 152 "src/main.c" 3 4
  stderr
# 152 "src/main.c"
  , "Assertion failed: %s\n", "expected sample_rate [44100,48000]"); printf("\n"); help("sound_meter"); exit(
# 152 "src/main.c" 3 4
  1
# 152 "src/main.c"
  ); } } while(0)
  ...
  case 'b':
   ...
   do { if (!(strcmp(option_block_size,"512") == 0 || strcmp(option_block_size,"1024") == 0 || strcmp(option_block_size,"2048") == 0)) { fprintf(
# 169 "src/main.c" 3 4
  stderr
# 169 "src/main.c"
  , "Assertion failed: %s\n", "expected block_size [512, 1024, 2028]"); printf("\n"); help("sound_meter"); exit(
# 169 "src/main.c" 3 4
  1
# 169 "src/main.c"
  ); } } while(0)
...
# 192 "src/main.c"
   ...
   config_filename = "sound_meter_config.json";
 }
 if (verbose_flag)
...
# 280 "src/main.c"
 ...
 ThirdOctaveData third_octave_data[30];


 for (int i = 0; i < sizeof(third_octave_data) / sizeof(third_octave_data[0]); i++){
 ...
 if (config_struct->calibration_time > 0) {
  ...
  unsigned milisecs = 0;
  unsigned calibration_milisecs = (config_struct->calibration_time + 2) * 1000;
  float average_sum = 0;
...
# 333 "src/main.c"
  "lenght_read <= sbuffer_write_size(ring_calibration)"
# 333 "src/main.c" 3 4
  , "src/main.c", 333, __extension__ __PRETTY_FUNCTION__); }))
# 333 "src/main.c"
                                                             ;
...
# 418 "src/main.c"
  "lenght_read <= sbuffer_write_size(third_octave_data[i].ring)"
# 418 "src/main.c" 3 4
  , "src/main.c", 418, __extension__ __PRETTY_FUNCTION__); }))
# 418 "src/main.c"
                                                                      ;
...
# 430 "src/main.c"
 "lenght_read <= sbuffer_write_size(ring_aslow)"
# 430 "src/main.c" 3 4
 , "src/main.c", 430, __extension__ __PRETTY_FUNCTION__); }))
# 430 "src/main.c"
                                                      ;
...
# 483 "src/main.c"
 ...
 config_save("./" "sound_meter_config.json");
