...
# 67 "src/process.c"
 ...
 if (buffer == 
# 71 "src/process.c" 3 4
              ((void *)0)
# 71 "src/process.c"
                  ) {
  free(levels);
  return 
# 73 "src/process.c" 3 4
        ((void *)0)
# 73 "src/process.c"
            ;
 }
...
# 140 "src/process.c" 3 4
((void) sizeof ((
# 140 "src/process.c"
sbuffer_size(ring) >= config_struct->segment_size
# 140 "src/process.c" 3 4
...
"sbuffer_size(ring) >= config_struct->segment_size"
# 140 "src/process.c" 3 4
, "src/process.c", 140, __extension__ __PRETTY_FUNCTION__); }))
# 140 "src/process.c"
                                                         ;
...
int event_check(Levels* levels, float background_level){
 ...
 fflush(
# 219 "src/process.c" 3 4
       stdout
# 219 "src/process.c"
             );

 if(noise_level > background_level + 10)
   return 1;
 return 0;
}
