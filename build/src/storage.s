	...
	.text
.Ltext0:
	.file 0 "/home/aluno/Desktop/sound_meter-master_v03_1" "src/storage.c"
	.data
...
.L15:
	...
	cmpq	$0, -4648(%rbp)
	je	.L16
	.loc 1 71 40 is_stmt 0 discriminator 1
	movq	-4648(%rbp), %rax
	addq	$1, %rax
	jmp	.L17
.L16:
	.loc 1 71 40 discriminator 2
	movq	-4680(%rbp), %rax
.L17:
	.loc 1 71 14 is_stmt 1 discriminator 4
	movq	%rax, -4648(%rbp)
	.loc 1 75 5
	movq	-4648(%rbp), %rcx
	movq	-4672(%rbp), %rdx
...
.LFB11:
	...
	jne	.L33
.L32:
	.loc 1 123 34 discriminator 3
	movl	$0, %eax
	.loc 1 123 34 is_stmt 0
	jmp	.L34
.L33:
...
.L35:
	...
	xorl	$1, %eax
	.loc 1 136 38 discriminator 1
	testb	%al, %al
	je	.L50
	.loc 1 136 59 discriminator 2
	movq	-88(%rbp), %rax
	movq	8(%rax), %rax
	.loc 1 136 54 discriminator 2
	testq	%rax, %rax
	je	.L50
	.loc 1 136 75 discriminator 3
	movq	-88(%rbp), %rax
	movq	16(%rax), %rax
	.loc 1 136 70 discriminator 3
	testq	%rax, %rax
	je	.L50
.LBB2:
	.loc 1 136 90 discriminator 4
	movq	%rsp, %rax
	movq	%rax, %rbx
	.loc 1 138 23
	movq	-88(%rbp), %rax
	...
	movq	%rax, %rdx
	.loc 1 138 10 is_stmt 1 discriminator 1
	subq	$1, %rdx
	movq	%rdx, -64(%rbp)
	movl	$16, %edx
	subq	$1, %rdx
...
.L42:
	...
	addq	$0, %rax
	movq	%rax, -56(%rbp)
	.loc 1 138 50 discriminator 2
	movq	-88(%rbp), %rax
	movq	8(%rax), %rdx
	.loc 1 138 37 discriminator 2
	movq	-56(%rbp), %rax
	movq	%rdx, %rsi
	movq	%rax, %rdi
	call	strcpy@PLT
	...
	movq	%rax, %rdi
	call	strlen@PLT
	.loc 1 139 22 is_stmt 0 discriminator 1
	movq	%rax, %rdx
	.loc 1 139 10 is_stmt 1 discriminator 1
	subq	$1, %rdx
	movq	%rdx, -48(%rbp)
	movl	$16, %edx
	subq	$1, %rdx
...
.LFB13:
	...
	cmpq	$0, -88(%rbp)
	je	.L54
	.loc 1 166 13 discriminator 2
	cmpq	$0, -96(%rbp)
	jne	.L55
.L54:
	.loc 1 166 34 discriminator 3
	movl	$0, %eax
...
.L59:
	...
	testq	%rax, %rax
	je	.L60
	.loc 1 174 29 discriminator 2
	movq	-88(%rbp), %rax
	movq	16(%rax), %rax
	.loc 1 174 23 discriminator 2
	testq	%rax, %rax
	jne	.L61
.L60:
	.loc 1 174 51 discriminator 3
	movl	$0, %eax
	.loc 1 174 51 is_stmt 0
	jmp	.L56
.L61:
...
.LBB4:
	...
	movq	%rax, %rdi
	call	strcmp@PLT
	.loc 1 184 12 discriminator 1
	testl	%eax, %eax
	je	.L73
	.loc 1 184 60 discriminator 2
	movq	-56(%rbp), %rax
	addq	$19, %rax
	.loc 1 184 48 discriminator 2
	leaq	.LC11(%rip), %rdx
	movq	%rdx, %rsi
	movq	%rax, %rdi
	call	strcmp@PLT
...
.LBB5:
	...
	movq	%rax, %rdi
	call	strlen@PLT
	.loc 1 192 39 discriminator 2
	addq	%rbx, %rax
	.loc 1 192 63 discriminator 2
	addq	$2, %rax
	movq	%rax, %rdx
...
.L69:
	...
	.loc 1 197 24
	movl	$0, %eax
	.loc 1 197 24 is_stmt 0 discriminator 1
	movq	%r12, %rsp
	jmp	.L56
.L70:
	movq	%r12, %rsp
...
.L80:
	...
	testq	%rax, %rax
	je	.L81
	.loc 1 219 33 discriminator 1
	movq	-24(%rbp), %rax
	movq	16(%rax), %rax
	.loc 1 219 26 discriminator 1
	movq	%rax, %rdi
	call	free@PLT
.L81:
	.loc 1 220 5
